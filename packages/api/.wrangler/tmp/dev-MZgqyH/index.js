...
// .wrangler/tmp/bundle-vo2uwS/checked-fetch.js
...
// .wrangler/tmp/bundle-vo2uwS/strip-cf-connecting-ip-header.js
...
var require_wasm2 = __commonJS({
  "../../node_modules/.prisma/client/wasm.js"(exports) {
    ...
    var config = {
      ...
      "inlineSchemaHash": "0299c0693f8b9e3aca5feff3350f8e2e57db28eaa8875ad7358f3b459a410c27",
      "copyEngine": true
    };
    config.dirname = "/";
    config.runtimeDataModel = JSON.parse('{"models":{"Project":{"fields":[{"name":"id","kind":"scalar","type":"String"},{"name":"name","kind":"scalar","type":"String"},{"name":"todos","kind":"object","type":"Todo","relationName":"ProjectToTodo"}],"dbName":null},"Todo":{"fields":[{"name":"id","kind":"scalar","type":"String"},{"name":"content","kind":"scalar","type":"String"},{"name":"is_completed","kind":"scalar","type":"Boolean"},{"name":"project","kind":"object","type":"Project","relationName":"ProjectToTodo"},{"name":"project_id","kind":"scalar","type":"String"}],"dbName":null}},"enums":{},"types":{}}');
...
// .wrangler/tmp/bundle-vo2uwS/middleware-loader.entry.ts
init_checked_fetch();
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();

// .wrangler/tmp/bundle-vo2uwS/middleware-insertion-facade.js
init_checked_fetch();
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
...
app.post("/api/todos", async (c) => {
  try {
    const { content, project_id } = await c.req.json();
